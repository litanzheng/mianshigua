...
import com.ling.mianshigua.constant.RedisConstant;
...
import static com.ling.mianshigua.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        StpUtil.login(user.getId(),"devvice");
...
//        request.getSession().removeAttribute(USER_LOGIN_STATE);
    ...
    public boolean addUserSignIn(long userId) {
        ...
        if (!signBitSet.get(offset)) {
            signBitSet.set(offset,true);
        }
        return true;
    }
